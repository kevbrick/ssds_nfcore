...
The samplesheet can have as many columns as you desire, however, there is a strict requirement for the first 3 columns to match those defined in the table below. Remember, SSDS samples MUST be run in paired-end mode as otherwise, key molecular features used to identify ssDNA cannot be identified. 
...
```
If this argument is not provided, the pipeline will attempt to use the genome passed using the -g parameter. 
